...
export default function TinhTroKhang({navigation}) {
  ...
  const onTinhToan = function () {
    ...
    if (slType === 1 && slInput === 1) {
      ...
      setIsResults(isI / isP / isP / isInput3);
    } else if (slType === 1 && slInput === 3) {
      console.log(LG.congSuatDienApDauVao);
      setIsResults((isP * isP * isInput3) / isI);
      ...
      setIsResults(isP / isI / isP / Math.sqrt(1 - isInput3 * isInput3));
    } else if (slType === 1 && slInput === 7) {
      console.log(LG.congSuatPhanKhangDienApDauVao);
      setIsResults((isI * isI * Math.sqrt(1 - isInput3 * isInput3)) / isP);
      ...
      console.log(LG.congSuatPhanKhangDongDienDauVao);
      setIsResults(isP / isI / isI / Math.sqrt(1 - isInput3 * isInput3));
      ...
      console.log(LG.congSuatTacDungDongDienDauVao);
      setIsResults(isI / isP / isP / isInput3 / Math.sqrt(3));
    } else if (slType === 3 && slInput === 3) {
      console.log(LG.congSuatDienApDauVao);
      setIsResults((Math.sqrt(3) * isP * isP * isInput3) / isI);
    } else if (slType === 3 && slInput === 4) {
      console.log(LG.congSuatBieuKienDongDienDauVao);
      setIsResults(isP / isI / isI / Math.sqrt(3));
    } else if (slType === 3 && slInput === 5) {
      console.log(LG.congSuatBieuKienDienApDauVao);
      setIsResults((Math.sqrt(3) * isI * isI) / isP);
    } else if (slType === 3 && slInput === 6) {
      console.log(LG.congSuatPhanKhangDongDienDauVao);
      setIsResults(
        isP / isI / isI / Math.sqrt(1 - isInput3 * isInput3) / Math.sqrt(3),
      );
    } else if (slType === 3 && slInput === 7) {
      console.log(LG.congSuatPhanKhangDienApDauVao);
      setIsResults(
        (Math.sqrt(3) * isI * isI * Math.sqrt(1 - isInput3 * isInput3)) / isP,
      );
  ...
  return (
    <SafeAreaView style={styles.viewSafe}>
      <TouchableOpacity
        ...
        />
        <Text style={styles.txtBack}>{LG.tinhTroKhang}</Text>
      </TouchableOpacity>
          ...
          <View style={styles.viewScroll}>
            <View style={styles.viewItem}>
              ...
              <View style={styles.viewInput1}>
                <View style={styles.viewSelect}>
                  <SelectDropdown
                    data={LG.type ? dataTypeTCSPK : dataTypeTCSPKEn}
              ...
              <View style={styles.viewItem}>
                ...
                <View style={styles.viewInput}>
                  <SelectDropdown
                    data={dataCosTCSPK}
                    onSelect={(selectedItem, index) => {
                      setIsInput3(selectedItem.value);
                    }}
                    defaultButtonText={LG.chon}
                    buttonTextAfterSelection={(selectedItem, index) => {
                      return selectedItem.label;
            ...
            {showResults === true && (
              <View style={styles.viewResult}>
                <View style={styles.viewItem}>
                  <View style={styles.viewName}>
                    <Text style={styles.txtTitle1}>{LG.troKhang}</Text>
                  </View>
                  <View style={styles.viewSign}>
