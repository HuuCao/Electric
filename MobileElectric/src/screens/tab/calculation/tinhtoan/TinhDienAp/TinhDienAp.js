...
export default function TinhDienAp({navigation}) {
  ...
  const onTinhToan = function () {
    ...
    if (slType === 1 && slInput === 1) {
      ...
      console.log('2-10');
      setIsResults(Math.sqrt((isP * isI) / Math.sqrt(1 - isCos * isCos)));
    } else if (slType === 2 && slInput === 11) {
      console.log('2-11');
      setIsResults(
        Math.sqrt((isP * isI) / isCos / Math.sqrt(1 - isCos * isCos)),
      );
      ...
      console.log('4-4');
      setIsResults(Math.sqrt((isP * isI) / isCos / Math.sqrt(3)));
    } else if (slType === 4 && slInput === 5) {
      console.log('4-5');
      setIsResults(Math.sqrt((isP * isI) / (isCos * isCos) / Math.sqrt(3)));
    } else if (slType === 4 && slInput === 6) {
      console.log('4-6');
      setIsResults(isI / isP / Math.sqrt(3));
    } else if (slType === 4 && slInput === 7) {
      console.log('4-7');
      setIsResults(Math.sqrt((isI * isP) / Math.sqrt(3)));
    } else if (slType === 4 && slInput === 8) {
      console.log('4-8');
      setIsResults(Math.sqrt((isP * isI) / isCos / Math.sqrt(3)));
    } else if (slType === 4 && slInput === 9) {
      console.log('4-9');
      setIsResults(isI / Math.sqrt(3) / isP / Math.sqrt(1 - isCos * isCos));
    } else if (slType === 4 && slInput === 10) {
      console.log('4-10');
      setIsResults(
        Math.sqrt((isP * isI) / Math.sqrt(1 - isCos * isCos) / Math.sqrt(3)),
      );
    } else if (slType === 4 && slInput === 11) {
      console.log('4-11');
      setIsResults(
        Math.sqrt(
          (isP * isI) / isCos / Math.sqrt(1 - isCos * isCos) / Math.sqrt(3),
        ),
      );
    }
  };
  ...
  const onConvertInput = function (e) {
    if (slType === 1 && e === 1) {
      ...
      setIsKiHieu1('I');
      setIsDonVi1('A');
      setIsName2(LG.congSuatPhanKhang);
      setIsKiHieu2('Q');
      setIsDonVi2('VAR');
      setShowCos(true);
      setIsNameKq(LG.dienApPha);
  ...
  return (
    <SafeAreaView style={styles.viewSafe}>
      <TouchableOpacity
        ...
        />
        <Text style={styles.txtBack}>{LG.tinhDienAp}</Text>
      </TouchableOpacity>
