...
export default function TinhCongSuatBieuKien({navigation}) {
  ...
  const [isNameKq, setIsNameKq] = useState(LG.congSuatBieuKien);
  const [isKiHieuKq, setIsKiHieuKq] = useState('S');
  ...
  const onTinhToan = function () {
    ...
    if (slType === 1 && slInput === 1) {
      ...
      console.log(LG.congSuatBieuKienHeSoCong);
      ...
      console.log(LG.dienApDongDienDauVao);
      setIsResults(isP * isI * Math.sqrt(3));
      ...
      console.log(LG.dongDienTongTro);
      setIsResults(isP * isP * isI * Math.sqrt(3));
    } else if (slType === 3 && slInput === 6) {
      console.log(LG.dongDienDienTro);
      setIsResults((isP * isI * isP * Math.sqrt(3)) / isCos);
    } else if (slType === 3 && slInput === 7) {
      console.log(LG.dienApTongTro);
      setIsResults((isP * isP * Math.sqrt(3)) / isI);
    } else if (slType === 3 && slInput === 8) {
      console.log(LG.dienApDienTro);
      setIsResults((isP * isP * isCos * Math.sqrt(3)) / isI);
    }
  };
  ...
  const onConvertType = function (e) {
    if (e === 1) {
      ...
      setInputSelect([
        ...
        {label: LG.congSuatPhanKhangHeSoCongSuat, value: 3},
        {label: LG.congSuatPhanKhangCongSuatTacDung, value: 4},
      ...
      setInputSelect([
        {label: LG.dienApDongDienDauVao, value: 1},
        {label: LG.congSuatTacDungHeSoCongSuat, value: 2},
        {label: LG.congSuatBieuKienHeSoCong, value: 3},
  ...
  const onConvertInput = function (e) {
    ...
    if (slType === 1 && e === 1) {
      ...
      setIsDonVi2('V');
      setShowCos(true);
      setIsNameKq(LG.congSuatBieuKien);
      setIsKiHieuKq('S');
  ...
  return (
    <SafeAreaView style={styles.viewSafe}>
      <TouchableOpacity
        ...
        />
        <Text style={styles.txtBack}>{LG.tinhCongSuatBieuKien}</Text>
      </TouchableOpacity>
            ...
            {showResults === true && (
              <View style={styles.viewResult}>
                <View style={styles.viewItem}>
                  ...
                  <View style={styles.viewUnit}>
                    <Text style={styles.txtTitle1}>{'VA'}</Text>
                  </View>
                </View>
              </View>
            )}
