...
import {dataNgat, dataNgatEn} from '../../../core/dataFake/dataSoCuu';
import {useSelector} from 'react-redux';

const arrowRight = require('../../../assets/icons/arrowRight-black.png');
export default function NgatScreen({navigation, route}) {
